    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50 p-8 flex flex-col items-center text-center gap-6">
          <div className="w-16 h-16 rounded-full bg-green-50 flex items-center justify-center border border-green-100 shadow-sm shadow-green-500/10">
            <CheckCircle className="w-8 h-8 text-green-500" />
          </div>
          <div>
            <h1 className="text-base font-bold text-slate-700">Verification Link Sent</h1>
            <p className="text-xs text-slate-450 mt-2 max-w-sm leading-relaxed">
              We've sent an email verification link to <span className="font-bold text-slate-750">{email}</span>. 
              Please verify your email address to activate your account.
            </p>
          </div>
          <Link
            href="/login"
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-xl transition-all shadow-lg shadow-indigo-600/10 hover:shadow-indigo-600/20 active:scale-95 text-xs sm:text-sm"
          >
            Back to Sign In
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50 p-8 flex flex-col gap-6">
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h2 className="text-base font-bold text-slate-700 mt-2">Create your account</h2>
        </div>
