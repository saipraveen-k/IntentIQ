  ...
  if (success) {
    return (
      <div className="min-h-screen bg-[#FCFAF7] flex items-center justify-center p-4 relative overflow-hidden font-sans">
        ...
        <div className="max-w-md w-full bg-white/80 backdrop-blur-md rounded-[2rem] border border-[#ECE9E0] shadow-[0_20px_50px_-12px_rgba(207,201,188,0.22)] p-8 sm:p-10 flex flex-col items-center text-center gap-6 relative z-10">
          <div className="w-16 h-16 rounded-full bg-[#EFF5F0] flex items-center justify-center border border-[#DCEBE0] shadow-sm">
            <CheckCircle className="w-8 h-8 text-[#3D6948]" />
          </div>
          <div>
            <h1 className="text-base font-bold text-[#2C302E]">Verification Link Sent</h1>
            <p className="text-xs text-[#8C867C] mt-2 max-w-sm leading-relaxed">
              We've sent an email verification link to <span className="font-bold text-[#5A6F57]">{email}</span>. 
              Please verify your email address to activate your account.
            </p>
          </div>
          <Link
            href="/login"
            className="w-full bg-[#2C302E] hover:bg-[#1C1F1E] text-[#FCFAF7] font-medium py-3.5 px-4 rounded-xl transition-all shadow-[0_4px_14px_rgba(44,48,46,0.12)] active:scale-[0.98] text-xs sm:text-sm"
          >
            Back to Sign In
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-[#FCFAF7] flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="max-w-md w-full bg-white/80 backdrop-blur-md rounded-[2rem] border border-[#ECE9E0] shadow-[0_20px_50px_-12px_rgba(207,201,188,0.22)] p-8 sm:p-10 flex flex-col gap-8 relative z-10">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <h2 className="text-base font-medium text-[#555047] mt-3">Create your account</h2>
        </div>
